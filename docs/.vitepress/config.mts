...
export default defineConfig({
  ...
  description: "Documentation for Trade Dialer - track global stock market hours, timezones, holidays, and trading overlaps for NYSE, NASDAQ, LSE, and 20+ exchanges worldwide.",
